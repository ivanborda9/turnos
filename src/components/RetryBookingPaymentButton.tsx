...
export function RetryBookingPaymentButton({ bookingId }: { bookingId: string }) {
  ...
  async function handleClick() {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/mercadopago/cancha/${bookingId}/retry`, { method: "POST" });
  ...
  return (
    <div>
      ...
      >
        {loading ? "Generando link..." : "Reintentar pago de la seña"}
      </button>
